...
/**
 * Network Image View class modification in order to add support for callbacks
 */
public class CallableNetworkImageView extends ImageView {
    ...
    public CallableNetworkImageView(Context context) {
        this(context, null);
    }

    public CallableNetworkImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CallableNetworkImageView(Context context, AttributeSet attrs, int defStyle) {
